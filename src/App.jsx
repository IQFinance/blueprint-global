...
function WhoThisIsFor() {
  ...
  const items = [
    "You earn income in more than one country — or plan to.",
    "You want a second residency or passport but don't know where to start.",
    "You hold crypto or digital assets and need compliant structure around them.",
    "You're planning a move abroad and want banking, tax, and legal sorted before you go.",
    "You've built wealth and want to protect it from being tied to one jurisdiction.",
    "You have a family and want education, healthcare, and succession planning that crosses borders."
  ];
