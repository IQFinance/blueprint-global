...
function Hero() {
  ...
  return (
    <section ref={heroRef} id="hero" className="relative min-h-[75dvh] lg:min-h-[calc(100dvh-6rem)] 2xl:min-h-[calc(100dvh-6rem)] pb-4 md:pb-12 w-full flex flex-col justify-end overflow-hidden bg-ink text-surface pt-24 lg:pt-28 scroll-mt-32">
