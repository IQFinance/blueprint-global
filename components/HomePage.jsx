...
function MidPageCTA({ headline, subheadline, buttonText = "Get Started", buttonLink = "/contact", dark = false }) {
  ...
  return (
    <section className={`${bg} py-20 px-6 md:px-12 border-t border-b relative z-10`}>
      <div className="max-w-3xl mx-auto text-center">
        ...
        <Link href={buttonLink} className="group inline-flex items-center gap-2 bg-bronze text-white px-8 py-4 rounded-[2rem] text-sm font-medium hover:bg-bronze/90 transition-all shadow-lg shadow-bronze/20">
...
function Hero() {
  ...
  return (
    <section ref={heroRef} id="hero" className="relative min-h-[75dvh] lg:flex-1 pb-4 md:pb-12 lg:pb-4 w-full flex flex-col justify-end overflow-hidden bg-ink text-surface pt-24 lg:pt-28 scroll-mt-32">
      ...
      <div className="relative z-10 w-full px-6 md:px-12 max-w-6xl 2xl:max-w-[85rem] mx-auto mt-auto pb-10 md:pb-24 lg:pb-0 xl:pb-12 2xl:pb-[20vh]">
        <div className="max-w-none text-left md:-ml-12 lg:-ml-20 lg:ml-0">
          ...
          <div className="hero-text flex flex-col sm:flex-row items-center sm:items-start gap-5">
            <Link href="/contact" className="group bg-surface text-ink px-8 py-4 rounded-[2rem] text-[15px] font-medium flex items-center justify-center gap-2 hover:bg-white transition-colors shadow-lg shadow-white/5 relative overflow-hidden">
    ...
    <section ref={eduRef} id="education" className="py-12 md:py-32 px-6 md:px-12 bg-porcelain relative overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <div className="edu-header mb-8 md:mb-20 text-center flex flex-col items-center">
          ...
          <h3 className="text-[1.65rem] sm:text-3xl md:text-4xl lg:text-[2.75rem] xl:text-[48px] font-drama font-normal tracking-tight text-ink leading-[1.2] md:leading-[1.1] max-w-none px-2">
            <span className="block text-ink mb-4 md:mb-6">We build your international life.</span>
            <span className="block text-bronze text-[2.2rem] md:text-5xl lg:text-[3.25rem] xl:text-[56px] font-medium">You live it.</span>
          </h3>
        </div>
    ...
    <section id="what-you-get" ref={getRef} className="py-12 md:py-32 px-6 md:px-12 bg-porcelain scroll-mt-24">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8 md:mb-16 flex flex-col items-center">
          ...
          <h3 className="text-[1.55rem] md:text-4xl lg:text-[2.75rem] xl:text-[48px] font-drama font-normal tracking-tight text-ink leading-[1.2] md:leading-[1.1] max-w-none px-2">
            <span className="block text-ink mb-4 md:mb-6">Strategic implementation.</span>
            <span className="block text-bronze text-[1.65rem] sm:text-[2rem] md:text-5xl lg:text-[3.25rem] xl:text-[56px] font-semibold md:font-normal">Everything, coordinated.</span>
          </h3>
        </div>
  ...
  useEffect(() => {
    ...
    let ctx = gsap.context(() => {
      gsap.from('.who-header', {
        scrollTrigger: { trigger: whoRef.current, start: 'top 85%', toggleActions: 'play none none none' },
        y: 30, opacity: 0, duration: 1, ease: 'power3.out'
      });
      gsap.from('.who-card-wrapper', {
        scrollTrigger: { trigger: whoRef.current, start: 'top 70%', toggleActions: 'play none none none' },
        y: 60, opacity: 0, duration: 1.2, stagger: 0.2, ease: 'power4.out'
      });
      gsap.from('.who-icon-inner', {
        scrollTrigger: { trigger: whoRef.current, start: 'top 65%', toggleActions: 'play none none none' },
        scale: 0, opacity: 0, duration: 0.8, stagger: 0.2, ease: 'back.out(2)', delay: 0.4
      });
    }, whoRef);
    return () => ctx.revert();
  }, []);
...
function HowItWorks() {
  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      gsap.from('.how-step', {
        scrollTrigger: { trigger: howRef.current, start: 'top 75%', toggleActions: 'play none none none' },
  ...
  const steps = [
    {
      num: "01", title: "Map", subtitle: "Strategic assessment.",
    ...
    {
      num: "02", title: "Build", subtitle: "Seamless execution.",
    ...
    {
      num: "03", title: "Maintain", subtitle: "Ongoing optimization.",
      ...
      <div className="max-w-5xl mx-auto relative flex flex-col pb-16">
        {steps.map((step, idx) => (
          <div
            ...
            style={{ top: `calc(100px + ${idx * 20}px)` }}
          >
          ...
          <div className="relative z-10 p-6 md:p-16 lg:p-20 flex flex-col md:flex-row gap-8 md:gap-20 items-center">
            <div className="w-full md:w-[320px] flex-shrink-0">
              <div className="aspect-video md:aspect-[4/5] w-full rounded-2xl overflow-hidden about-item ring-1 ring-bronze/20 shadow-2xl relative group">
                <img src="/martin.jpg" alt="Martin Popiel - Founder" className="w-full h-full object-cover object-[center_20%] filter contrast-[1.05] saturate-[0.85] group-hover:scale-105 transition-transform duration-700" />
            ...
            <div className="about-item flex-grow flex flex-col text-left">
              ...
              <div className="mb-4 md:mb-6">
                <h2 className="text-xl md:text-3xl lg:text-4xl font-drama font-normal tracking-tight text-white mb-1">Martin Popiel, CPA</h2>
              ...
              <div className="text-white/80 font-sans leading-relaxed text-[15px] md:text-[19px] max-w-2xl mb-6 md:mb-10 space-y-4">
                <p>Martin lives the international life he builds for others. With multiple citizenships, residencies and businesses across three continents, he understands the complexity of a global footprint.<span className="hidden md:inline"> One firm for banking. Another for residency. Another for tax. None of them talking to each other.</span></p>
                <p>He founded Blueprint to solve this problem, providing a single team to coordinate your entire international structure under one roof.</p>
              </div>
...
function FAQ() {
  ...
  const questions = [
    { icon: <Scale size={18} className="text-bronze flex-shrink-0" />, q: "Is this legal?", a: "Yes, fully. Every structure we coordinate is built on established legal frameworks, implemented by licensed professionals in each jurisdiction. We work with tax attorneys, immigration lawyers, and banking compliance officers to ensure everything is transparent and above board." },
    { icon: <Clock size={18} className="text-bronze flex-shrink-0" />, q: "How long does this take?", a: "It depends on your situation. Some structures can be in place within 6 months. More complex, multi-jurisdiction roadmaps can take a year or longer. We scope the timeline during your initial assessment." },
    { icon: <Coins size={18} className="text-bronze flex-shrink-0" />, q: "How much does it cost?", a: "It depends on the scope. A single residency application is different from a full multi-jurisdiction structure. We provide a clear quote after the initial assessment: no hidden fees, no hourly billing surprises." },
    { icon: <Users size={18} className="text-bronze flex-shrink-0" />, q: "I already have an accountant and lawyer. Do I still need this?", a: "Probably. Your local accountant and lawyer are great for domestic matters. But cross-border structuring requires coordination across multiple jurisdictions: that\u2019s the gap Blueprint fills. We work alongside your existing team, not against them." },
    { icon: <RefreshCw size={18} className="text-bronze flex-shrink-0" />, q: "What if my situation changes after we build the structure?", a: "That\u2019s what the Maintain phase is for. Laws change, life changes. We handle renewals, annual filings, and structural adjustments so everything stays current and compliant." }
  ];
